...
public class ItemRiftBlade extends ItemSword implements DDObject {
    ...
    public MovingObjectPosition getMovingObjectPositionFromPlayer(World par1World, EntityPlayer par2EntityPlayer, boolean par3) {
        ...
        return par1World.func_147447_a(var13, var23, true, false, false); // Function: raytraceblocks_do_do
    }
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        if (!world.isRemote) {
            List<EntityLivingBase> list = world.getEntitiesWithinAABB(EntityLiving.class, AxisAlignedBB.getBoundingBox(player.posX - 10, player.posY - 10, player.posZ - 10, player.posX + 10, player.posY + 10, player.posZ + 10));
            list.remove(player);
    ...
    public boolean getIsRepairable(ItemStack par1ItemStack, ItemStack par2ItemStack) {
        ...
        return Item.getIdFromItem(DDItems.itemStableFabric) == Item.getIdFromItem(par2ItemStack.getItem());
    }
