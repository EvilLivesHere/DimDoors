...
import StevenDimDoors.dimdoors.util.JSONValidator;
...
public class DimDataProcessor extends BaseConfigurationProcessor<PackedDimData> {
    ...
    /**
     * validates the save file against it's current version, then updates and validates it again if it needs it then it loads it
     *
     * @param reader
     * @return
     * @throws IOException
