...
public class DDLoot {
    ...
    public static void registerInfo() {
        ...
        addContent(DDProperties.instance().FabricOfRealityLootEnabled, items, Item.getItemFromBlock(DDBlocks.blockDimWall), 20, 16, 64);
        addContent(DDProperties.instance().WorldThreadLootEnabled, items, DDItems.itemWorldThread, 80, 2, 12);
    ...
    public static void fillGraveChest(IInventory inventory, Random random) {
        ...
        if (DDProperties.instance().RiftBladeLootEnabled && random.nextInt(100) < 10) {
            stacks.add(new ItemStack(DDItems.itemRiftBlade, 1));
        } else {
