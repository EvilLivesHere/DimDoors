...
public class CustomCaveGen extends MapGenBase {
     ...
     */
    protected void generateLargeCaveNode(long par1, int par3, int par4, Block[] par5ArrayOfBlocks, double par6, double par8, double par10) {
        this.generateCaveNode(par1, par3, par4, par5ArrayOfBlocks, par6, par8, par10, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    /**
     * Generates a node in the current cave system recursion tree.
     */
    protected void generateCaveNode(long par1, int par3, int par4, Block[] par5ArrayOfBlocks, double par6, double par8, double par10, float par12, float par13, float par14, int par15, int par16, double par17) {
        ...
        for (boolean var28 = var25.nextInt(6) == 0; par15 < par16; ++par15) {
            ...
            if (!var54 && par15 == var27 && par12 > 1.0F && par16 > 0) {
                this.generateCaveNode(var25.nextLong(), par3, par4, par5ArrayOfBlocks, par6, par8, par10, var25.nextFloat() * 0.5F + 0.5F, par13 - ((float) Math.PI / 2F), par14 / 3.0F, par15, par16, 1.0D);
                this.generateCaveNode(var25.nextLong(), par3, par4, par5ArrayOfBlocks, par6, par8, par10, var25.nextFloat() * 0.5F + 0.5F, par13 + ((float) Math.PI / 2F), par14 / 3.0F, par15, par16, 1.0D);
                return;
            }
                        ...
                        for (int var43 = var56; !var58 && var43 < var40; ++var43) {
                            for (int var44 = var38 + 1; !var58 && var44 >= var57 - 1; --var44) {
                                ...
                                if (var44 >= 0 && var44 < 128) {
                                    if (par5ArrayOfBlocks[var45] == Blocks.flowing_water
                                            || par5ArrayOfBlocks[var45] == Blocks.water) {
                                        var58 = true;
                                    }
                                ...
                                if (var59 * var59 + var46 * var46 < 1.0D) {
                                    for (int var50 = var38 - 1; var50 >= var57; --var50) {
                                        ...
                                        if (var51 > -0.7D && var59 * var59 + var51 * var51 + var46 * var46 < 1.0D) {
                                            Block block = par5ArrayOfBlocks[var48];

                                            if (block == Blocks.grass) {
                                                var49 = true;
                                            }

                                            if (block == DDBlocks.blockLimbo || block == Blocks.dirt || block == Blocks.grass) {
                                                if (var50 < 10) {
                                                    par5ArrayOfBlocks[var48] = Blocks.flowing_lava;
                                                } else {
                                                    par5ArrayOfBlocks[var48] = Blocks.air;

                                                    if (var49 && par5ArrayOfBlocks[var48 - 1] == Blocks.dirt) {
                                                        par5ArrayOfBlocks[var48 - 1] = this.worldObj.getBiomeGenForCoords(var42 + par3 * 16, var45 + par4 * 16).topBlock;
                                                    }
                                                }
                                            }
                                        }
     ...
     */
    @Override
    protected void func_151538_a(World par1World, int par2, int par3, int par4, int par5, Block[] par6ArrayOfBlocks) { // function: recursiveGenerate
        ...
        for (int var8 = 0; var8 < var7; ++var8) {
            ...
            if (this.rand.nextInt(4) == 0) {
                this.generateLargeCaveNode(this.rand.nextLong(), par4, par5, par6ArrayOfBlocks, var9, var11, var13);
            ...
            for (int var16 = 0; var16 < var15; ++var16) {
                ...
                this.generateCaveNode(this.rand.nextLong(), par4, par5, par6ArrayOfBlocks, var9, var11, var13, var19, var17, var18, 0, 0, 1.0D);
            }
        }
    }
}
