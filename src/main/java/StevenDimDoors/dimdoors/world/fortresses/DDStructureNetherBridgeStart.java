...
public class DDStructureNetherBridgeStart extends StructureStart {
    ...
    public DDStructureNetherBridgeStart(Random random, int chunkX, int chunkZ) {
        ...
        if (random.nextInt(MAX_GATEWAY_GENERATION_CHANCE) < DDProperties.instance().FortressGatewayGenerationChance) {
            ...
            while (componentIterator.hasNext()) {
                ...
                if (component instanceof Throne) {
                    spawnerRooms.add((Throne) component);
                }
            }
