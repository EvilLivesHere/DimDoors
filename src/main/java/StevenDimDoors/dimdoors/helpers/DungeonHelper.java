...
import StevenDimDoors.dimdoors.dungeon.pack.DungeonPackConfigReader;
...
public class DungeonHelper {
    ...
    public static void registerDungeons() {
        File file = new File(DDProperties.instance().CustomSchematicDirectory);
        ...
        registerCustomDungeons(DDProperties.instance().CustomSchematicDirectory, reader);
    }
    ...
    private static DungeonPack registerDungeonPack(String directory, Iterable<String> schematics, boolean isInternal, boolean verbose, DungeonPackConfigReader reader) {
    ...
    public static List<DungeonData> getRegisteredDungeons() {
        return Collections.unmodifiableList(DungeonHelper.registeredDungeons);
    }

    public static List<DungeonData> getUntaggedDungeons() {
        return Collections.unmodifiableList(DungeonHelper.untaggedDungeons);
    }

    public static DungeonData getDefaultErrorDungeon() {
        return defaultError;
    }

    public static DungeonPack getDungeonPack(String name) {
    ...
    private static DungeonPack getDimDungeonPack(NewDimData dimension) {
    ...
    public static DimLink createCustomDungeonDoor(World world, int x, int y, int z) {
        ...
        ItemDimensionalDoor.placeDoorBlock(world, x, y, z, 3, DDBlocks.warpDoor);
    ...
    public static void registerDungeon(String schematicPath, DungeonPack pack, boolean isInternal, boolean verbose) {
    ...
    private static void registerCustomDungeons(String path, DungeonPackConfigReader reader) {
        File[] schematics;
    ...
    private static void registerBundledDungeons(DungeonPackConfigReader reader) {
    ...
    private static DungeonPack registerBundledPack(String name, DungeonPackConfigReader reader) {
        ...
        InputStream listStream = DungeonHelper.class.getResourceAsStream(listPath);
    ...
    public static DungeonData selectNextDungeon(NewDimData parent, Random random) {
    ...
    public static ArrayList<String> getDungeonNames() {
    ...
    /**
     * Lists all of the dungeons found by iterating through a dimension's ancestors. The search stops when a non-dungeon dimension is found or when the pack of
     * a dungeon differs from the specified pack.
     *
