...
import StevenDimDoors.dimdoors.core.IDimRegistrationCallback;
...
public class Compactor {
    ...
    public static void write(Collection<? extends NewDimData> values, ByteBuf output) {
    ...
    public static void readDimensions(ByteBuf input, IDimRegistrationCallback callback) {
