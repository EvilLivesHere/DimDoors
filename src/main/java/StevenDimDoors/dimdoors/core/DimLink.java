...
public abstract class DimLink {
    ...
    protected DimLink(Point4D point, int orientation, DDLock lock, LinkType linkType) {
         ...
         *
         * if ((linkType < LinkTypes.ENUM_MIN || linkType > LinkTypes.ENUM_MAX) && linkType != LinkTypes.CLIENT_SIDE) { throw new IllegalArgumentException("The
         * specified link type is invalid."); }
         *
         */
