...
public abstract class DDSkyRenderer extends IRenderHandler {
    ...
    public abstract ResourceLocation getMoonRenderPath();

    public abstract ResourceLocation getSunRenderPath();
