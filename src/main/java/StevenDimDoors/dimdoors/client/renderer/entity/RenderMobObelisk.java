...
public class RenderMobObelisk extends RenderLiving {
    ...
    @Override
    public void func_110827_b(EntityLiving entity, double x, double y, double z, float par8, float par9) {
        ...
        super.func_110827_b(entity, x, y, z, par8, par9); // Not sure about this....
    }

    public void render(EntityLiving par1EntityLivingBase, double x, double y, double z, float par8, float par9) {
        if (MinecraftForge.EVENT_BUS.post(new RenderLivingEvent.Pre(par1EntityLivingBase, this, x, y, z))) {
            return;
        }
        GL11.glPushMatrix();
