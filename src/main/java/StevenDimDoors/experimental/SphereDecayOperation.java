...
/**
 * Provides an operation for damaging structures based on a spherical area. The chance of damage decreases with the square of the distance from the center of
 * the sphere.
 *
 * @author SenseiKiwi
 *
