...
/**
 * Provides an implementation of a linked list that exposes its internal nodes. This differs from Java's implementation, which does not expose nodes. Access to
 * the nodes allows certain operations to be implemented more efficiently. Not all operations are supported, but we can add them as the need arises.
 *
 * @author SenseiKiwi
 *
...
public class LinkedList<T> implements Iterable<T> {
    ...
    private static class Node<P> implements ILinkedListNode<P> {
        ...
        Node(Node<P> prev, Node<P> next, P data, LinkedList<P> owner) {
            this.prev = prev;
            this.next = next;
            this.data = data;
            this.owner = owner;
    ...
    private static class LinkedListIterator<P> implements Iterator<P> {
        ...
        LinkedListIterator(LinkedList<P> list) {
